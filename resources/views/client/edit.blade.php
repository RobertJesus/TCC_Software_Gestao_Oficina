            ...
            <form action="{{ route('client.update', $data->id) }}" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3 has-feedback {{ $errors->has('data') ? 'has-error' : '' }}">
                        ...
                        <input type="date" name="date" class="form-control dateClient" value="{{$data->date}}">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        @if ($errors->has('data'))
                            <span class="help-block">
                    ...
                    <div class="form-group col-md-3 has-feedback {{ $errors->has('CPF/CNPJ') ? 'has-error' : '' }}">
                        ...
                        <input for="text" name="record" class="form-control idenClient" placeholder="12345678" value="{{$data->record}}">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    ...
                    <div class="form-group col-md-2">
                        <label>Sexo</label>
                            <select class="form-control sexoClient" name="sex" value="{{$data->sex}}">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2 has-feedback {{ $errors->has('celular') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="phoneP" class="form-control celClient" placeholder="19-99121-0699" value="{{$data->phoneP}}">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                ...
                <div class="form-row">
                    <div class="form-group col-md-5 has-feedback {{$errors->has('endereco') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="address" class="form-control endClient" id="inputCity" placeholder="Endereço" value="{{$data->address}}">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    ...
                    <div class="form-group col-md-2 has-feedback {{$errors->has('bairro') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="district" class="form-control bairroClient" id="inputCity" placeholder="Bairro" value="district">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    ...
                    <div class="form-group col-md-2 {{$errors->has('numero') ? 'has-error' : '' }}">
                        <label>Numero</label>
                        <input type="text" name="numberHouse" class="form-control numClient" placeholder="123" min="1" value="{{$data->numberHouse}}">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4 has-feedback {{$errors->has('cidade') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="city" class="form-control cityClient" id="inputCity" placeholder="Cidade" value="{{$data->city}}">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    ...
                    <div class="form-group col-md-2 has-feedback {{$errors->has('cep') ? 'has-error' : '' }}">
                        ...
                        <input type="number" name="cep" class="form-control cepClient" id="inputZip" placeholder="13835-000" value="{{$data->cep}}">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        @if ($errors->has('cep'))
                            <span class="help-block">
